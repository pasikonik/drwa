          ...
          <div class="cinfo io">
            <div class="cinfo__item">
              ...
              <div>
                ...
                <p class="cinfo__d"><a href="mailto:kontakt@drwa.pl">kontakt@drwa.pl</a> — najpewniejsza droga.</p>
              </div>
            </div>
            <div class="cinfo__item">
              <div class="cinfo__ic">
              ...
              <div>
                <p class="cinfo__t">Dolina Harmonii</p>
                <p class="cinfo__d">Dolnośląskie, okolice Jeleniej Góry. Dokładny adres wysyłamy w potwierdzeniu zapisu na warsztat.</p>
              </div>
            </div>
